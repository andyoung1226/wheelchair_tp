...
class makecsv():
    def __init__(self):
        ...
        self.filename = './data/{0}/auto_data/data.csv'.format(self.today)
        self.auto_sub = rospy.Subscriber('/auto_csv', Bool, self.auto_callback)
        self.idx_pub = rospy.Publisher('/auto_index', Int8, queue_size = 1)
        self.cnt = 1
